...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('APPOINTMENT_CONFIRMED', 'APPOINTMENT_CANCELLED', 'APPOINTMENT_REMINDER', 'APPOINTMENT_RESCHEDULED', 'PAYMENT_SUCCESS');
...
-- CreateIndex
CREATE UNIQUE INDEX "Availability_staffMemberId_dayOfWeek_startTime_endTime_key" ON "Availability"("staffMemberId", "dayOfWeek", "startTime", "endTime");

-- CreateIndex
CREATE INDEX "AvailabilityException_staffMemberId_date_idx" ON "AvailabilityException"("staffMemberId", "date");

-- CreateIndex
CREATE UNIQUE INDEX "AvailabilityException_staffMemberId_date_key" ON "AvailabilityException"("staffMemberId", "date");

-- CreateIndex
CREATE UNIQUE INDEX "BusinessClosure_organizationId_date_key" ON "BusinessClosure"("organizationId", "date");
...
-- AddForeignKey
ALTER TABLE "StaffService" ADD CONSTRAINT "StaffService_staffMemberId_fkey" FOREIGN KEY ("staffMemberId") REFERENCES "OrganizationMember"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Availability" ADD CONSTRAINT "Availability_staffMemberId_fkey" FOREIGN KEY ("staffMemberId") REFERENCES "OrganizationMember"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AvailabilityException" ADD CONSTRAINT "AvailabilityException_staffMemberId_fkey" FOREIGN KEY ("staffMemberId") REFERENCES "OrganizationMember"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BusinessClosure" ADD CONSTRAINT "BusinessClosure_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_staffMemberId_fkey" FOREIGN KEY ("staffMemberId") REFERENCES "OrganizationMember"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
